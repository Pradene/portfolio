...
class Position {
  ...
  constructor(initialPos = { x: 0, y: 0 }) {
    ...
    /** @private */
    this.easeFactor = 0.4 // Controls the lerp speed (0 = instant, 1 = no movement)
  }
   ...
   */
  update() {
    this.currentPos.x = lerp(this.currentPos.x, this.targetPos.x, this.easeFactor)
    this.currentPos.y = lerp(this.currentPos.y, this.targetPos.y, this.easeFactor)
